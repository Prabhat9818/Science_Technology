...
const NewsLetter = () => {
  return (
   ...
   <section className='bg-primary p-10'>
    ...
    <div className="mx-auto mt-10 max-w-7xl px-6 sm:mt-36 lg:px-8" data-aos="fade-up"
                data-aos-delay="300">
    <div
        className="relative isolate overflow-hidden bg-gray-900 px-6 py-10 shadow-2xl rounded-2xl sm:rounded-3xl sm:px-24 xl:py-32">
