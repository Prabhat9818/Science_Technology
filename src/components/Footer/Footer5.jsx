...
const Footer = () => {
  return (
    <div className="bg-gradient-to-r from-black via-[#0d0d0e] to-black">
      <section className="max-w-[1200px] mx-auto text-white">
      <footer className="bg-gradient-to-r from-black via-[#242c33] to-black">
    ...
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
      ...
      <img src={Logo} className="w-20 h-20" alt="logo" />
        ...
        <div className="flex mt-8 space-x-6 text-white">
          <a className="hover:opacity-75 cursor-pointer" href target="_blank" rel="noreferrer">
      ...
      <div className="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          ...
          <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-400">
            ...
            <a className="hover:opacity-75" href> Robotic </a>
            <a className="hover:opacity-75" href> Technology </a>
            <a className="hover:opacity-75" href> Rocket Science </a>
          </nav>
        </div>
        <div>
          <p className="font-medium">
